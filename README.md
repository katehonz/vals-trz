...
Уеб-базирана система за управление на персонала и изчисляване на работни заплати (ТРЗ), вдъхновена от EJ ARFA. Проектът предоставя пълен набор от функции за HR отдели и счетоводители в български предприятия.
